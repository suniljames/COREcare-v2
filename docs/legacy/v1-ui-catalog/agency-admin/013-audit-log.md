...
- "Kill All Active Sessions" → red button gated by `is_superuser` is rendered on this page; it triggers [100-kill-all](100-kill-all.md) (POST-only emergency kill switch).
