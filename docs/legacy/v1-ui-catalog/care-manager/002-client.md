...
---
**CTAs visible:** "← Back", per-care-team-member "Email" buttons, "Schedule" tab, "Charting" tab, "Vitals" tab, "Requests" tab, per-action "Remind <caregiver>" button, "Alert admin".
...
- ⚠ destructive: per-action "Remind <caregiver>" and "Alert admin" buttons → POSTs to action-handler URLs that mutate the action queue. Skipped by crawler.
