...
| Pre-shift reminder email | internal | `send_shift_reminders` Render cron runs `*/15 * * * *`; scans for shifts starting within 15 hours; respects 9pm–7am Pacific quiet hours (Issue #642) | outbound; sync | [`/caregiver/schedule/` (Caregiver section pending)](v1-pages-inventory.md#auth_service) | 🔒 PHI · Sees: shift summary with magic-link to `caregiver/schedule/`. Template `emails/shift_reminder`. EmailEvent category: `shift_reminder`. | missing | H |
