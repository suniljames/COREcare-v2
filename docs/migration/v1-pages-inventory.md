...
### dashboard
_family portal landing, per-client detail, billing PDF, health-report PDF; mounted under `/dashboard/family/` (`dashboard/urls.py` is included at `/dashboard/` per `elitecare/urls.py:186`)_
