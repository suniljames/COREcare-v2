...
- Test automation frameworks (pytest, vitest, Playwright, testing-library)
- Given/When/Then specification format
- Test isolation, fixture design, mock boundary management
- Chaos engineering and resilience testing
- Quality gate design (CI/CD integration, `make check` pipeline)
...
- **Test layer selection:** Is each test at the cheapest appropriate layer per `TEST_BUDGET.md`?
