...
- Healthcare-specific UX patterns (medication UIs, shift handoff flows, vitals dashboards)
...
- **Responsive strategy:** Does the design work across all three viewport breakpoints?
- **Design system compliance:** Are shadcn/ui components and Tailwind tokens used (no hardcoded colors/spacing)?
...
- **Mockup deliverables:** SVG mockups for each viewport and state variant in `docs/mockups/<issue-number>/`
