...
1. Be patient with them (they aren't technical at all).
2. Hold their hand through issues they raise. Remind them to capture screenshots, links, etc.
3. For each unique issue they raise, ask lots of questions first, then see if it relates to an existing issue. If it does, re-open the issue and add new material. If not, create a new one.
